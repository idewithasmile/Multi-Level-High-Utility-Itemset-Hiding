 ...
 *
 */
public class OutputTypeListWindow {
	 ...
	 */
	public OutputTypeListWindow(boolean runAsStandalone) throws Exception {
	...
	public static void displayTypes(List<String> algorithms, boolean runAsStandalone) throws Exception {
		// Create a new frame
		JFrame frame = new JFrame("SPMF - List of Algorithms by Output Types");
		if (runAsStandalone) {
		...
		for (String algorithmName : algorithms) {
			...
			String[] inputTypesOfAlgorithm = algorithm.getOutputFileTypes();
...
//				}
		...
		inputList.setCellRenderer(new OutputTypeListCellRenderer());
		...
		JLabel inputLabel = new JLabel("Output Types (" + inputTypesList.size() + ")", SwingConstants.CENTER);
	...
	public static void main(String[] args) throws Exception {
		...
		OutputTypeListWindow viewer = new OutputTypeListWindow(true);
	}
	
	// Create a custom ListCellRenderer class that extends DefaultListCellRenderer
	private static class OutputTypeListCellRenderer extends DefaultListCellRenderer {
	    /**
		 * Serial UID
		 */
