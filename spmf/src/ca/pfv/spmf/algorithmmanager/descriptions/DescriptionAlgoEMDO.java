...
*/
/**
 * This class describes the EMDO algorithm parameters. It is designed to be used
 * by the graphical and command line interface.
 * 
 * @see AlgoPEMDO
 * @author O. Ouarem et al.
 */
public class DescriptionAlgoEMDO extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoEMDO() {
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		algo.findFrequentEpisodesEMDO(minsup, singleEpisodeEvent); // EMDO !!!!
		algo.saveEpisodesToFile(outputFile);
		algo.printStats();
	}
